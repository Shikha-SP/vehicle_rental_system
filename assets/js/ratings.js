...
let selectedRating = reviewModal && reviewModal.dataset.rating ? reviewModal.dataset.rating : 0;
        ...
        fetch('submit_ratings.php', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('openReviewModal').textContent = 'Edit your review';
                }
            });
    });