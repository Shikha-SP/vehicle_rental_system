...
if (isset($response_data['status']) && $response_data['status'] === 'Completed') {
    ...
    $discount_amount = $_SESSION['khalti_discount_amount'] ?? 0.00;
    $discount_id = $_SESSION['khalti_discount_id'] ?? null;
    ...
    try {
        ...
        if ($discount_id) {
            ...
            $conn->query("UPDATE discount_codes SET used_count = used_count + 1 WHERE id = $discount_id");
