...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cardnumber'])) {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            // check if user came from an extension flow
    ...
    foreach ($raw_codes as $rc) {
        if ($rc['owner_user_id'] === null) {
            ...
            if (strpos($cname, 'BRONZE') !== false && $u_medal === 'NONE')
                continue;
            if (strpos($cname, 'SILVER') !== false && in_array($u_medal, ['NONE', 'BRONZE']))
                continue;
                ...
                <section class="card-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cardholder-name" id="cardholder-name" class="input-field"
                            placeholder="James T. Sterling" value="<?= htmlspecialchars($cardholdername ?? '') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="kharcha-card-input-wrap">
                            <input type="text" name="cardnumber" id="card-number" class="input-field"
                                placeholder="4111 1111 1111 1111" value="<?= htmlspecialchars($cardnumber ?? '') ?>">
                            <span class="card-type-badge card-type-badge--visa" id="badge-visa" style="display:none;"><i
                                    class="fa-brands fa-cc-visa"></i> Visa</span>
                            <span class="card-type-badge card-type-badge--mastercard" id="badge-mastercard"
                                style="display:none;"><i class="fa-brands fa-cc-mastercard"></i> MC</span>
                            <span class="card-type-badge card-type-badge--amex" id="badge-amex" style="display:none;"><i
                                    class="fa-brands fa-cc-amex"></i> Amex</span>
                            <span class="card-type-badge card-type-badge--kharcha" id="badge-kharcha"
                                style="display:none;"><i class="fa-solid fa-circle-check"></i> Kharcha</span>
                        </div>
                            ...
                            <div class="expiry-dropdowns">
                                ...
                                <select name="expiry_year" id="expiry-year" class="input-field">
                                    ...
                                    <?php for ($y = (int) date('Y'); $y <= (int) date('Y') + 10; $y++): ?>
                                        <option value="<?= $y ?>" <?= ($expiry_year == $y) ? 'selected' : '' ?>><?= $y ?>
                                        </option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                ...
                <section class="billing-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="street" id="street" class="input-field"
                            placeholder="123 Performance Way" value="<?= htmlspecialchars($street ?? '') ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="zip" id="zip" class="input-field" placeholder="44600"
                                value="<?= htmlspecialchars($zip ?? '') ?>" maxlength="5" pattern="\d{5}"
                                inputmode="numeric">
            ...
            <div id="tab-kharcha" class="tab-content" style="display:none;">
                <div class="kharcha-card-panel">
                    ...
                    <div class="kharcha-subtabs" id="kharcha-subtabs">
                        <button type="button" class="kh-subtab active" data-khtab="kh-portal"
                            onclick="switchKharchaTab('kh-portal')">
                    ...
                    <div id="kh-portal" class="kh-subtab-content">
                        ...
                        <div class="portal-amount-display">
                            ...
                            <span class="portal-amount-value" id="kharcha-portal-amount">NPR
                    ...
                    <div id="kh-qr" class="kh-subtab-content" style="display:none;">
                        ...
                        <div class="qr-panel" id="qr-panel">
                            <div class="qr-idle" id="qr-idle">
                                ...
                                <button type="button" class="qr-generate-btn" id="qr-generate-btn"
                            ...
                            <div class="qr-active" id="qr-active" style="display:none;">
                                ...
                                <p class="qr-scan-hint">
                                    ...
                                    Open the <strong>Kharcha app</strong>, tap <em>Scan &amp; Pay</em>, then scan this
                                    QR code.
                                </p>
                                <button type="button" class="qr-refresh-btn" id="qr-refresh-btn"
                                    onclick="generateQRCode()" style="display:none;">
            ...
            <div id="tab-esewa" class="tab-content" style="display:none;">
                <div class="esewa-panel">
                    ...
                    <div class="esewa-amount-display">
                        ...
                        <span class="esewa-amount-value" id="esewa-amount-display">NPR
                            <?= number_format($totalprice, 0) ?></span>
                    </div>
            ...
            <div id="tab-khalti" class="tab-content" style="display:none;">
                <div class="khalti-panel">
                    ...
                    <div class="khalti-subtabs" id="khalti-subtabs">
                        <button type="button" class="kh2-subtab active" data-kh2tab="kh2-portal"
                            onclick="switchKhaltiTab('kh2-portal')">
                            <i class="fa-solid fa-arrow-up-right-from-square"></i> Payment Portal
                        </button>
                        <button type="button" class="kh2-subtab" data-kh2tab="kh2-qr"
                            onclick="switchKhaltiTab('kh2-qr')">
                    ...
                    <div id="kh2-portal" class="kh2-subtab-content">
                        ...
                        <div class="khalti-amount-display">
                            ...
                            <span class="khalti-amount-value" id="khalti-amount-display">NPR
                                <?= number_format($totalprice, 0) ?></span>
                        </div>
                    ...
                    <div id="kh2-qr" class="kh2-subtab-content" style="display:none;">
                        ...
                        <div class="qr-panel" id="khalti-qr-panel">
                            ...
                            <div class="qr-idle" id="khalti-qr-idle">
                                <div class="qr-idle-icon" style="color:#e5c97e;"><i class="fa-solid fa-qrcode"></i>
                                </div>
                                <p class="qr-idle-text">Click below to generate your Khalti payment QR</p>
                                <div class="qr-amount-badge"
                                    style="background:rgba(229,201,126,0.12); border-color:rgba(229,201,126,0.3); color:#e5c97e;">
                                    NPR <?= number_format($totalprice, 0) ?></div>
                            ...
                            <div class="qr-active" id="khalti-qr-active" style="display:none;">
                                ...
                                <button type="button" class="qr-refresh-btn" id="khalti-qr-refresh-btn"
                                    onclick="generateKhaltiQR()"
                                    style="display:none; border-color:rgba(229,201,126,0.4); color:#e5c97e;">
                                    <i class="fa-solid fa-rotate-right"></i> Generate New QR
                                </button>
                            </div>
                            ...
                            <div class="qr-success" id="khalti-qr-success" style="display:none;">
                                <div class="qr-success-icon" style="color:#e5c97e;"><i
    ...
    <div id="summary-section">
        ...
        <div class="booking-panel">
            ...
            <?php if ($source === 'extend_booking' || (isset($_SESSION['payment_source']) && $_SESSION['payment_source'] === 'extend_booking')):
                ...
                ?>
                <h2>Additional Price: NPR <span id="extension-additional-price"><?= number_format($totalprice, 0) ?></span>
                </h2>
    ...
    function generateQRCode() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                wrap.innerHTML = '';
                new QRCode(wrap, {
                    text: data.qr_payload, width: 200, height: 200,
