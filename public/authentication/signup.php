            ...
            <section class="signup-form-panel">
                ...
                <?php else: ?>
                    ...
                    <div class="signup-heading">
                        <span
                            class="signup-heading__line1"><?= $current_step === 1 ? 'Create Your' : 'Verify Your' ?></span>
                        <span
                            class="signup-heading__line2"><?= $current_step === 1 ? 'Driver Profile' : 'Driving Credentials' ?></span>
                    </div>
                    ...
                    <form class="signup-form" method="POST" novalidate>
                        ...
                        <?php if ($current_step === 1): ?>
                            ...
                            <div class="signup-form__group">
                                ...
                                <div id="passwordMatchFeedback" class="error-message" style="display:none;">Passwords do not
                                    match</div>
                                <div id="passwordMatchValid" class="valid-feedback" style="display:none;">✓ Passwords match
                                </div>
                            </div>
                            ...
                            <div class="signup-form__row">
                                <div class="signup-form__group">
                                    ...
                                    <div class="license-preview" id="licensePreview" style="display:none;">
                                        <svg class="license-preview-icon" xmlns="http://www.w3.org/2000/svg" fill="none"
