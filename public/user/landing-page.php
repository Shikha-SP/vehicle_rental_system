 ...
 * ==========================================================
 * New Landing Page
 * File: public/user/landing-page.php
 * ==========================================================
 */
...
<main class="dashboard-content">
    ...
    <header class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="vechile.php" class="btn btn-primary">SECURE THE FLEET</a>
                <a href="vechile.php" class="btn btn-secondary">EXPLORE SPECS</a>
            </div>
        </div>
    </header>
    ...
    <section class="cta">
        ...
        <div class="cta-action-area">
            <a href="#" class="btn btn-white">DISCOVER CARS</a>
        </div>
