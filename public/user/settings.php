                ...
                <div class="settings-page-nav">
                    ...
                    <?php if (empty($_SESSION['is_admin'])): ?>
                        <a href="settings.php?section=delete"
                            class="settings-page-nav-item delete-item <?= $active_section === 'delete' ? 'active' : '' ?>">
                ...
                <?php elseif ($active_section === 'delete' && empty($_SESSION['is_admin'])): ?>
                    ...
                    <div class="settings-page-card">
                        ...
                        <form>
                            ...
                            <div class="settings-page-form-group">
                                <label for="confirm_text">Type <code class="settings-page-code">DELETE MY ACCOUNT</code> to
                                    confirm *</label>
                    ...
                    <div class="settings-page-card">
                        ...
                        <div class="settings-page-user-info">
                            <div class="settings-page-user-info__details">
                                ...
                                <p style="font-size: 12px; margin-top: 8px;">Member since:
                        ...
                        <div style="margin-top: 24px;">
                            <h3 style="font-family: var(--font-display); font-size: 18px; margin-bottom: 16px;">Quick
                                Actions</h3>
                        ...
                        <?php if (empty($_SESSION['is_admin'])): ?>
                            <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--clr-border);">
                                <h3
                                    style="font-family: var(--font-display); font-size: 18px; margin-bottom: 16px; color: #ff6b6b;">
                                    Danger Zone</h3>
